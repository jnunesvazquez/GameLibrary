...
public class Constants {
    ...
    public static final String PLAYER_A = "SHIP A  BLUE LASER";
    public static final String PLAYER_B = "SHIP B  GREEN LASER";
    public static final String PLAYER_C = "SHIP C  RED LASER";
